          ...
          <Grid>
            ...
            >
              <p>
                ...
                probably the two most commonly used data structures in day to
                day development, followed by Hashmaps (dictionaries in Python
                and objects in JS).
              </p>
              <p>
                {" "}
                Data structures hold data and can be manipulated in certain ways
                to retrieve that data. The means by which we store and get the
                data out of a data structure is what allows us to leverage them
                throughout our code to write algorithms for specific problems.{" "}
              </p>
              <p>
              ...
              <p>
                There are a handful of less well known data structures that can
                be useful in certain circumstances which you can learn about
                below.
              </p>
              ...
              <ul style={{ marginTop: 0 }}>
                ...
                <li>
                  <Link to="/projects/xplained/ds/sll">Singly Linked List</Link>
                </li>
                <li>
                  <Link to="/projects/xplained/ds/dll">Doubly Linked List</Link>
                </li>
              </ul>
