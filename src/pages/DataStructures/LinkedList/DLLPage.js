      ...
      <Grid border=".25rem white solid">
        <Grid container direction="column" margin="0 auto" paddingBottom="2rem">
          ...
          <Grid width="90%" margin="0 auto">
            ...
            >
              <p>
                A doubly linked list follows the same concept as a singly linked
                list except there can be addition/deletion/traversal from either
              ...
              <p>
                ...
                functionality. The difficult part of this method is making sure
                to wire up all of the nodes appropriately. We need to be
                concerned about 3 nodes - the new node that we are inserting and
                the nodes before/after that node.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Prepending a node to the doubly linked list is insertion at the
                tail. If the list is empty we just set the tail and head to be
                that node. Otherwise, we can simply call our insertBefore method
                and insert before the 0th index.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Inserting after is just as useful as insertBefore and the logic
                is almost entirely the same except we must wire up our nodes in
                the reverse order.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Appending a node is the opposite of prepending, we are inserting
                at the head of the list. The logic here is the same except we
                call insertAfter with the last index instead of insertBefore
                with the 0th.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Getting the data from a node is very simple when leveraging the
                helper method of the same name. We get the node and then return
                the data.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Removing a node from a doubly linked list is almost exactly the
                same as removing form a singly linked list. Except in the case
                of removing the head, we must also reset the head to be the
                previous node.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                algorithmic complexity of the operations being performed on the
                list would be that of an array as opposed to a linked list
                defeating the purpose of using this data structure in the first
                place.
              </p>
              <DSDivider />
              <DLLDemo />
