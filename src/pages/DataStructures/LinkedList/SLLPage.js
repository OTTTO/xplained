  ...
  return (
    <Grid border="double thick black" id="outerGrid">
      <Grid border=".25rem white solid">
        <Grid container direction="column" margin="0 auto" paddingBottom="2rem">
          ...
          <Grid width="90%" margin="0 auto">
            ...
            >
              ...
              <p>
                ...
                the other hand, addition and deletion from the front of an array
                depends on its size as we have to shift the entire array while
                it is almost instant for a linked list (for a doubly linked list
                append/delete from both the front and the back are both
                'instant')
              </p>
              <p>
                Although we almost always rely on arrays in our day to day work,
                a linked list can be useful in certain situations - we will
                actually see one leveraged in our implementation of HashMap
                later on.
              </p>
              ...
              <p>
                ...
                explanation. You will see the doubly linked list implementation
                on the next page.
              </p>
              <DSDivider />
              <p>
                A singly linked list is composed of a sequence of Nodes which
                each contain <b>data</b> and a reference to the <b>next</b> Node
                in the list.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                properties. <b>size</b> which tracks the length of the list. The
                other two necessary properties are <b>tail</b>
              ...
              <DSDivider />
              <p>
                For a singly linked list, when we add a new node we append it to
                the front of the list. If the list is empty we simply set the
                tail to be the new node. Otherwise, we step all the way through
                the List and tack the node on to the end.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                When we want to remove a node from the linked list, firt we make
                sure that the list is not empty and that the index is in bounds.
                We then iterate the list up until the index we want to remove -
                1. Then we take that node and point it to the node after the
                node we want to remove, effectively dropping it from the linked
                list.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                not empty and that the index is not out of bounds. If we cannot
                remove a node because it violates one of these conditions, we
                simply return false. Otherwise we just iterate up until the
                given index and return the node's data.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                method is useful to help us iterate the list with a for loop, a
                more advanced linked list would have an iterator on it that we
                can just call next on until it is exhausted.
              </p>
              <CodeBlock
