          ...
          <Grid width="90%" margin="0 auto">
            ...
            >
              <p>
                ...
                placed on top of another and you can only remove the one at the
                top.
              </p>{" "}
              ...
              <DSDivider />
              <p>
                First we need a way to represent the elements that are going to
                be added to the stack. We do this with a Node class which has a
                property to store the <b>data</b> and another to store a
              ...
              <p>
                ...
                property, <b>top</b>, which as the name implies, always points
                to the top of the stack which is our access point.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                sets the newly added node to be the top and points it to the old
                top in order to extend the stack.
              </p>
              <CodeBlock
              ...
              <p>
                ...
                or even import it. For example, in both JavaScript and Python, a
                list can serve as a queue.
              </p>
              <CodeBlock
