          ...
          <Grid width="90%" margin="0 auto">
            ...
            >
              ...
              <p>
                ...
                either front to back or top down, trees branch out with nodes in
                multiple directions.
              </p>

              <p>
                A tree consists of a root node where all of the branching
                begins, we typically place the root at the top when we visualize
                these structures.
              </p>
              <p>
                Every node has only one parent (except the root which has none)
                and each node can have zero or more children. If a node has zero
                children, we call it a leaf.
              </p>
              <p>
              ...
              <p>
                ...
                the algorithmic complexity of search is O(log(n)). But depending
                on how we insert data into our BST it can degenerate to O(n),
                for example if items are inserted in an already sorted order.
                Due to this, we will use the binary search tree implementation
                as a jump off point to eventually learn about trees that balance
                themselves and are guaranteed to maintain O(log(n)) insertion
                and search.
              </p>
              <p>
              ...
              <p>
                ...
                then <b>left</b>/<b>right</b>: references to the left and right
                children. We don't need to store the root of the BST because we
                know that the first node will always be the root and then we
              ...
              <p>
                ...
                set the node with the key and the data, otherwise we recurse to
                the left or the right depending on if the key is less than or
                greater than the current node. Once we hit the bottom of the
                tree that is when we do the actual insertion.
              </p>
              <CodeBlock
              ...
              <DSDivider />
              <p>
                Checking if an element exists is how we search for elements in a
                BST. It is done by recursively climbing down the children
              ...
              <p>
                ...
                exists but instead of returning a boolean we return the data of
              ...
              <p>
                ...
                right child. The successor is always the min of the right child
                and it will take the place of the deleted node.
              </p>
              <CodeBlock
